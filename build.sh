...
docker/dockcross-android-arm bash -c "cd build/android-arm && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-android-arm64 bash -c "cd build/android-arm64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-android-x64 bash -c "cd build/android-x64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-android-x86 bash -c "cd build/android-x86 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-arm bash -c "cd build/linux-arm && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-arm64 bash -c "cd build/linux-arm64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-mips64 bash -c "cd build/linux-mips64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-ppc64le bash -c "cd build/linux-ppc64le && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-musl-arm bash -c "cd build/linux-musl-arm && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 -DAARU_MUSL=1 ../.."
...
docker/dockcross-linux-musl-arm64 bash -c "cd build/linux-musl-arm64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 -DAARU_MUSL=1 ../.."
...
docker/dockcross-linux-s390x bash -c "cd build/linux-s390x && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-x64 bash -c "cd build/linux-x64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-linux-x86 bash -c "cd build/linux-x86 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-win-arm bash -c "cd build/win-arm && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-win-arm64 bash -c "cd build/win-arm64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-win-x64 bash -c "cd build/win-x64 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
...
docker/dockcross-win-x86 bash -c "cd build/win-x86 && cmake -DCMAKE_BUILD_TYPE=Release -DAARU_BUILD_PACKAGE=1 ../.."
